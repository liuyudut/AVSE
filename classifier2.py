...
class CLASSIFIER:
    ...
    def fit_zsl(self):
        ...
        for epoch in range(self.nepoch):
            ...
            #acc = self.val(self.train_feature, self.train_label, self.seenclasses)
            # print('acc %.4f' % (acc))
            if acc > best_acc:
                best_acc = acc
        return best_acc
